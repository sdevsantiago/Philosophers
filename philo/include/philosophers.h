...
/*   Updated: 2025/10/15 22:29:27 by sede-san         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
extern pthread_mutex_t	*forks_init(
							size_t philos_count);

extern void				forks_clear(
							pthread_mutex_t *forks,
							size_t philos_count);

extern void				forks_take(
							t_philo *philo);

extern void				forks_drop(
							t_philo *philo);

// philos.c

extern t_philo			*philos_init(
							t_table *table,
							long meals_count);

extern void				philos_clear(
							t_philo *philos);

extern void				philo_eat(
							t_philo *philo);

extern void				philo_sleep(
							t_philo *philo);

extern void				philo_think(
							t_philo *philo);
...
extern void				*philo_routine(
							void *arg);

extern void				*waiter_routine(
							void *arg);

extern int				philo_has_starved(
							t_philo *philo);
